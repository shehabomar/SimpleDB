...
public class PlanCache {
    ConcurrentHashMap<Set<LogicalJoinNode>, Vector<LogicalJoinNode>> bestOrders = new ConcurrentHashMap<Set<LogicalJoinNode>, Vector<LogicalJoinNode>>();
    ConcurrentHashMap<Set<LogicalJoinNode>, Double> bestCosts = new ConcurrentHashMap<Set<LogicalJoinNode>, Double>();
    ConcurrentHashMap<Set<LogicalJoinNode>, Integer> bestCardinalities = new ConcurrentHashMap<Set<LogicalJoinNode>, Integer>();

    /**
     * Add a new cost, cardinality and ordering for a particular join set. Does not
     * verify that the
     * new cost is less than any previously added cost -- simply adds or replaces an
    ...
    /**
     * Find the cardinality of the best join order in the cache for the specified
     * plan
     * 
